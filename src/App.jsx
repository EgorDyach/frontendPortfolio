...
const content = [
  { title: "Веб-приложение, аналог Pomodoro timer", link: "https://rad-profiterole-eb06b3.netlify.app/", img: img14, descr: "В данном проекте я создал приложение с помощью react и redux. Добавил возможность создавать, удалять, менять приоритет у задач. Создал сам таймер, зобавил блок настроек таймера. Реализовал темную тему и сохранение данных в localStorage." },
